    ...
    const fetchProducts = async () => {
      try {
        ...
        const { data } = await axios.get(
          `/api/product/searchProduct?category=${category}&minPrice=${minPrice}&maxPrice=${maxPrice}&keyword=${keyword}`
        );
            ...
            <section className="p-10 bg-white ">
              <div className="flex justify-between">
                <h1 className="text-2xl">
                  {"Mens Products"} ({products ? products.length : 0})
                </h1>
                <div className="flex gap-10">
                  ...
                  <button>
                    <span className="text-lg">
                      Sort By <i class="fa-sharp fa-solid fa-chevron-down"></i>
                    </span>
                  </button>
                </div>
              </div>
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 pr-10">
                ...
                <div className={`col-span-1`}>
                  <div className="p-10 flex flex-col gap-5">
                    <span className="flex justify-between">
                      ...
                      <button
                        onClick={() => toggleDD(categorydd, setCategorydd)}
                      >
                        <i
                          class={`fa-sharp fa-solid fa-chevron-${
                            categorydd ? "up" : "down"
                          }`}
                        ></i>
                      </button>
                      ...
                      <div>
                        <div className="flex gap-3">
                          <input
                            ...
                            checked={category === "Shoes" ? true : false}
                            type="checkbox"
                            className="h-5 w-5 text-indigo-600 rounded-md border-gray-300 focus:ring-indigo-500"
                          ></input>
                          <p>Shoes</p>
                        </div>
                        <div className="flex gap-3">
                          <input
                            ...
                            checked={category === "Clothing" ? true : false}
                            type="checkbox"
                            className="h-5 w-5 text-indigo-600 rounded-md border-gray-300 focus:ring-indigo-500"
                          ></input>
                          <p>Clothing</p>
                        ...
                        <div className="flex gap-3">
                          <input
                            ...
                            checked={category === "Apperal" ? true : false}
                            type="checkbox"
                            className="h-5 w-5 text-indigo-600 rounded-md border-gray-300 focus:ring-indigo-500"
                          ></input>
                          <p>Apparel</p>
                  ...
                  <div className="p-10 flex flex-col gap-5">
                    <span className="flex justify-between">
                      <h1>Shop by Price</h1>
                      <button onClick={() => toggleDD(pricedd, setPricedd)}>
                        <i
                          class={`fa-sharp fa-solid fa-chevron-${
                            pricedd ? "up" : "down"
                          }`}
                  ...
                  <div className="p-10 flex flex-col gap-5">
                    <span className="flex justify-between">
                      <h1>Brand </h1>
                      <button onClick={() => toggleDD(branddd, setBranddd)}>
                        <i
                          class={`fa-sharp fa-solid fa-chevron-${
                            branddd ? "up" : "down"
                          }`}
                ...
                <>
                  ...
                  <div
                    className={`text-center md:text-left ${
                      hidefilters
                        ? "col-span-2 md:col-span-4 md:ml-8"
                  ...
                  >
                    <div className={` flex h-40 justify-center itemss-center`}>
                      <Loader />
                    </div>
                    <div className={`flex h-40 justify-center itemss-center`}>
                      <Loader />
              ...
              >
                {products && products.length > 0 ? (
                      ...
                      <div className="flex justify-center items-center md:items-start md:justify-start">
                        ...
                        >
                          <img
                            ...
                            className={`md:h-72 object-cover md:w-72 ${
                              hidefilters ? "pl-16" : ""
                            } `}
                          ></img>
                  ...
                  <>
                    {!loading && (
                      <div className="col-span-3 flex justify-center items-center text-4xl text-center font-bold">
                        No Product Found
                      </div>
                    )}
                  </>
